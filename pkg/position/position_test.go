...
func TestPositionToFen(t *testing.T) {
	...
	tests := []struct {
		...
		{"rnbqkbnr/pppppppp/8/4R3/8/8/PPPPPPPP/1NBQKBNR w KQkq - 0 1"},
		{"rnbqkb1r/pp1p1pPp/8/2p1pP2/1P1P4/3P3P/P1P1P3/RNBQKBNR w KQkq e6 0 1"},
		{"rnbqkbnr/pp5p/2pppp2/6p1/2B1P3/2N2P1N/PPPP2PP/R1BQK1R1 b Qkq - 1 6"},
	...
	for _, tt := range tests {
		t.Run("", func(t *testing.T) {
			...
			if p.GetFen() != tt.fen {
				t.Errorf("incorrect halfmove count: expected %v, got %v", tt.fen, p.GetFen())
			}
